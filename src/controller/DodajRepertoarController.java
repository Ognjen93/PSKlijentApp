...
public class DodajRepertoarController implements Initializable {
    ...
    private boolean dodajRepertoar() throws IOException{
        ...
        try {
            ...
            if (!PregledSvihRepertoaraController.izmjenaRepertoara) {
                repertoar = new Repertoar(0,
                        new Date(sdf.parse(cmbGodina.getSelectionModel().getSelectedItem().toString()
                ...
                repertoar.setMjesecIGodina(new Date(sdf.parse(cmbGodina.getSelectionModel().getSelectedItem().toString()
                        + "-" + Integer.valueOf(cmbMjesec.getSelectionModel().getSelectedItem()).toString() + "-1").getTime()));
...
//              Repertoar(Integer id,Date mjesecIGodina)
                out.println(ProtocolMessages.DODAJ_REPERTOAR.getMessage()+repertoar.getId()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+strDate);
                if(in.readLine().startsWith(ProtocolMessages.DODAJ_REPERTOAR_OK.getMessage())){
                ...
                out.println(ProtocolMessages.DODAJ_KREIRANJE.getMessage()+"null"+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+kreiranje.getIdRepertoara()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()
            ...
            DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            String strDate = dateFormat.format(repertoar.getMjesecIGodina());
            out.println(ProtocolMessages.IZMIJENI_REPERTOAR.getMessage()+repertoar.getId()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+strDate);
            if(in.readLine().startsWith(ProtocolMessages.IZMIJENI_REPERTOAR_OK.getMessage())){
            ...
            out.println(ProtocolMessages.DODAJ_AZURIRANJE.getMessage()+"null"+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+repertoar.getId()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+
                    "null"+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+LogInController.idLogovanog);
