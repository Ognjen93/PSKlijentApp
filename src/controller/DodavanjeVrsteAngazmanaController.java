...
public class DodavanjeVrsteAngazmanaController implements Initializable {
    ...
    void okAction(ActionEvent event) {
        try {
            ...
            out.println(ProtocolMessages.DODAJ_ANGAZMAN_VA.getMessage()+textFieldNaziv.getText());
            if(in.readLine().startsWith(ProtocolMessages.DODAJ_ANGAZMAN_VA_OK.getMessage())){
