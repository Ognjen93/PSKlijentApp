...
//      rezervacije(Date termin, Integer idScene)
            ...
            out.println(ProtocolMessages.ADD_REZERVACIJA.getMessage()+ PregledKarataController.rezervacije.getId()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage() +PregledKarataController.rezervacije.getIme()+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+ strDate + ProtocolMessages.MESSAGE_SEPARATOR.getMessage() + PregledKarataController.rezervacije.getIdScene());
            if(in.readLine().startsWith(ProtocolMessages.ADD_REZERVACIJA_OK.getMessage())) {
            	System.out.println("Rezervacija uspjesno dodata");
            }
            out.println(ProtocolMessages.REZERVACIJE.getMessage()+terminPredstave+ ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+ scenaZaPrikaz.getIdScene());
...
//                      Rezervacija(Integer id, String ime, Date termin, Integer idScene)
            ...
            if (!rezervacijaList.stream().filter(e -> e.getIme().equals(imeRezervacije)).findAny().isPresent()) {
                ...
                out.println(ProtocolMessages.ADD_REZERVACIJA.getMessage() + 0 + ProtocolMessages.MESSAGE_SEPARATOR.getMessage() + imeRezervacije + ProtocolMessages.MESSAGE_SEPARATOR.getMessage() +
...
//          new RezervisanoSjediste(scenaZaPrikaz.getIdScene(), Integer.parseInt(e.getId()), temp.getId(), temp.getTermin());
                out.println(ProtocolMessages.ADD_REZERVISANO_SJEDISTE.getMessage() + scenaZaPrikaz.getIdScene() + ProtocolMessages.MESSAGE_SEPARATOR.getMessage() + Integer.parseInt(e.getId()) +
