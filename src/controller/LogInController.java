...
public class LogInController implements Initializable {
    ...
    private boolean provjeraAutentifikacije(String username, String password) {
        try {
            ...
            out.println(ProtocolMessages.AUTH_REQUEST.getMessage()+username+ProtocolMessages.MESSAGE_SEPARATOR.getMessage()+passwordHash+ProtocolMessages.MESSAGE_SEPARATOR.getMessage());
